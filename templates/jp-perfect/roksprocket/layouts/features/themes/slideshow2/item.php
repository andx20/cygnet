...
<li class="sprocket-features-index-<?php echo $index;?>">
	...
	<?php endif; ?>
	<div class="sprocket-features-content uk-container uk-container-center <?php if (($parameters->get('features_show_title') && $item->getTitle() == FALSE) && ($parameters->get('features_show_article_text') && $item->getText() == FALSE)) : echo ' sprocket-none'; endif; ?>" data-slideshow2-content>
		<div class="sprocket-features-padding">
			...
			<?php if ($parameters->get('features_show_article_text') && ($item->getText() || $item->getPrimaryLink())) : ?>
				<div class="sprocket-features-desc">
					...
					<?php if ($item->getPrimaryLink()) : ?>
					<br><a style="margin:20px 0" href="<?php echo $item->getPrimaryLink()->getUrl(); ?>" class="readon uk-button uk-button-primary"><?php rc_e('READ_MORE'); ?></a>
					<?php endif; ?>
				</div>
			<?php endif; ?>
		</div>
