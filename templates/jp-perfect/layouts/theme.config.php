...
// add css
$this['asset']->addFile('css', 'css:joomlaplates.css');
$this['asset']->addFile('css', 'css:theme.css');
if (($menuposition = $this['config']->get('menuposition')) && $this['path']->path("css:/$menuposition.css")) { $this['asset']->addFile('css', "css:/$menuposition.css"); }
